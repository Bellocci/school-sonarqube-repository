...
public class StudentSwingViewIT extends AssertJSwingJUnitTestCase {
	...
	/**
	 * Utilizziamo un database in memoria
	 */
	@BeforeClass
	...
	/**
	 * First of all, we verify that when the controller’s method allStudents is called, the frame’s list is
	 *	populated with the students in the database:
	 */
	...
	/**
	 * we verify that the view and the controller interact correctly when a student is added through
	 * the “Add” button.
	 */
	...
	/**
	 * For the scenario where a student with the same id is already present, we need to first add a student
	 * to the database through the repository. Then we verify that the student does not appear in the list
	 * and that instead an error message is shown in the view.
	 */
	...
	/**
	 * verify that the view and the controller interact correctly when a student is deleted
