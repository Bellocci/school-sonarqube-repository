...
public class SchoolControllerIT {
	...
	/**
	 * Note that we still use Mockito for verifying the expected behavior of our controller,
	 * while interacting with a real database.
	 */
	@Mock
	...
	public void setUp() {
		...
		studentRepository = new StudentMongoRepository(
				new MongoClient(
						new ServerAddress("localhost", mongoPort)), SCHOOL_DB_NAME, STUDENT_COLLECTION_NAME);
